...
try:
    ...
    for i in range(1, intlen + 1):
        print("--------------------------------------------------------------")
        # Get random Integer
        random.seed(132514247) #seed random number generator
...
writer = pd.ExcelWriter(r'C:\Users\alifa\OneDrive\Documents\Universitas Malaya\FYP\Quantum\Seeded CSC\Seeded Data.xlsx',mode='a')
df1.to_excel(writer, index=False, sheet_name='10')
writer.save()
